...
/******  SAM4S4C specific Interrupt Numbers *********************************/
  ...
  EFC_IRQn             =  6, /**<  6 SAM4S4C Enhanced Embedded Flash Controller (EFC) */
  UART0_IRQn           =  8, /**<  8 SAM4S4C UART 0 (UART0) */
  UART1_IRQn           =  9, /**<  9 SAM4S4C UART 1 (UART1) */
  SMC_IRQn             = 10, /**< 10 SAM4S4C Static Memory Controller (SMC) */
...
#define __CM4_REV              0x0000 /**< SAM4S4C core revision number ([15:8] revision number, [7:0] patch number) */
