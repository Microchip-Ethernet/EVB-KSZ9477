...
/******  SAM4S4A specific Interrupt Numbers *********************************/
  ...
  EFC_IRQn             =  6, /**<  6 SAM4S4A Enhanced Embedded Flash Controller (EFC) */
  ...
  DACC_IRQn            = 30, /**< 30 SAM4S4A Digital To Analog Converter (DACC) */
...
#define __CM4_REV              0x0000 /**< SAM4S4A core revision number ([15:8] revision number, [7:0] patch number) */
