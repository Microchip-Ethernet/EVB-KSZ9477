...
/** \addtogroup SAM4S8A_definitions SAM4S8A definitions
  This file defines all structures and symbols for SAM4S8A:
...
/* ************************************************************************** */
/*   CMSIS DEFINITIONS FOR SAM4S8A */
/* ************************************************************************** */
/** \addtogroup SAM4S8A_cmsis CMSIS Definitions */
/*@{*/
...
/******  SAM4S8A specific Interrupt Numbers *********************************/
  
  SUPC_IRQn            =  0, /**<  0 SAM4S8A Supply Controller (SUPC) */
  RSTC_IRQn            =  1, /**<  1 SAM4S8A Reset Controller (RSTC) */
  RTC_IRQn             =  2, /**<  2 SAM4S8A Real Time Clock (RTC) */
  RTT_IRQn             =  3, /**<  3 SAM4S8A Real Time Timer (RTT) */
  WDT_IRQn             =  4, /**<  4 SAM4S8A Watchdog Timer (WDT) */
  PMC_IRQn             =  5, /**<  5 SAM4S8A Power Management Controller (PMC) */
  EFC_IRQn             =  6, /**<  6 SAM4S8A Enhanced Embedded Flash Controller (EFC) */
  UART0_IRQn           =  8, /**<  8 SAM4S8A UART 0 (UART0) */
  UART1_IRQn           =  9, /**<  9 SAM4S8A UART 1 (UART1) */
  PIOA_IRQn            = 11, /**< 11 SAM4S8A Parallel I/O Controller A (PIOA) */
  PIOB_IRQn            = 12, /**< 12 SAM4S8A Parallel I/O Controller B (PIOB) */
  USART0_IRQn          = 14, /**< 14 SAM4S8A USART 0 (USART0) */
  TWI0_IRQn            = 19, /**< 19 SAM4S8A Two Wire Interface 0 (TWI0) */
  TWI1_IRQn            = 20, /**< 20 SAM4S8A Two Wire Interface 1 (TWI1) */
  SPI_IRQn             = 21, /**< 21 SAM4S8A Serial Peripheral Interface (SPI) */
  SSC_IRQn             = 22, /**< 22 SAM4S8A Synchronous Serial Controller (SSC) */
  TC0_IRQn             = 23, /**< 23 SAM4S8A Timer/Counter 0 (TC0) */
  TC1_IRQn             = 24, /**< 24 SAM4S8A Timer/Counter 1 (TC1) */
  TC2_IRQn             = 25, /**< 25 SAM4S8A Timer/Counter 2 (TC2) */
  ADC_IRQn             = 29, /**< 29 SAM4S8A Analog To Digital Converter (ADC) */
  DACC_IRQn            = 30, /**< 30 SAM4S8A Digital To Analog Converter (DACC) */
  PWM_IRQn             = 31, /**< 31 SAM4S8A Pulse Width Modulation (PWM) */
  CRCCU_IRQn           = 32, /**< 32 SAM4S8A CRC Calculation Unit (CRCCU) */
  ACC_IRQn             = 33, /**< 33 SAM4S8A Analog Comparator (ACC) */
  UDP_IRQn             = 34  /**< 34 SAM4S8A USB Device Port (UDP) */
} IRQn_Type;
...
#define __CM4_REV              0x0000 /**< SAM4S8A core revision number ([15:8] revision number, [7:0] patch number) */
#define __MPU_PRESENT          1      /**< SAM4S8A does provide a MPU */
#define __FPU_PRESENT          0      /**< SAM4S8A does not provide a FPU */
#define __NVIC_PRIO_BITS       4      /**< SAM4S8A uses 4 Bits for the Priority Levels */
...
/* ************************************************************************** */
/**  SOFTWARE PERIPHERAL API DEFINITION FOR SAM4S8A */
/* ************************************************************************** */
/** \addtogroup SAM4S8A_api Peripheral Software API */
/*@{*/
...
/* ************************************************************************** */
/*   REGISTER ACCESS DEFINITIONS FOR SAM4S8A */
/* ************************************************************************** */
/** \addtogroup SAM4S8A_reg Registers Access Definitions */
/*@{*/
...
/* ************************************************************************** */
/*   PERIPHERAL ID DEFINITIONS FOR SAM4S8A */
/* ************************************************************************** */
/** \addtogroup SAM4S8A_id Peripheral Ids Definitions */
/*@{*/
...
/* ************************************************************************** */
/*   BASE ADDRESS DEFINITIONS FOR SAM4S8A */
/* ************************************************************************** */
/** \addtogroup SAM4S8A_base Peripheral Base Address Definitions */
/*@{*/
...
/* ************************************************************************** */
/*   PIO DEFINITIONS FOR SAM4S8A */
/* ************************************************************************** */
/** \addtogroup SAM4S8A_pio Peripheral Pio Definitions */
/*@{*/

#include "pio/SAM4S8A.h"
/*@}*/

/* ************************************************************************** */
/*   MEMORY MAPPING DEFINITIONS FOR SAM4S8A */
/* ************************************************************************** */
