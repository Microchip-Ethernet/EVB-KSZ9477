...
/* $Id: //depot/swdev/LAN/Switch/KSZ/kernels/linux-3.18/drivers/char/applicom.c#3 $			     */
...
static int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: //depot/swdev/LAN/Switch/KSZ/kernels/linux-3.18/drivers/char/applicom.c#3 $\n");
...
{				/* @ ADG ou ATO selon le cas */
	...
	case 5:
		...
		break;
	case 6:
		printk(KERN_INFO "APPLICOM driver release .... V2.8.0 ($Revision: #3 $)\n");
