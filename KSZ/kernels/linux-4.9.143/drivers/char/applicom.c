...
/* $Id: //depot/swdev/LAN/Switch/KSZ/kernels/linux-4.9.143/drivers/char/applicom.c#1 $			     */
...
static int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: //depot/swdev/LAN/Switch/KSZ/kernels/linux-4.9.143/drivers/char/applicom.c#1 $\n");
