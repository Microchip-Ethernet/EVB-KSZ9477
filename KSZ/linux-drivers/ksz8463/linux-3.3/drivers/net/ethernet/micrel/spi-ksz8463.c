...
#ifndef DEVINIT
#if defined(CONFIG_SPI_FTDI) && defined(CONFIG_SPI_KSZ8463)
#define DEVINIT
#else
...
static int DEVINIT ksz8463_probe(struct spi_device *spi)
{
...
static int __devexit ksz8463_remove(struct spi_device *spi)
{
...
static struct spi_driver ksz8463_driver = {
	...
	.probe = ksz8463_probe,
	.remove = __devexit_p(ksz8463_remove),
};
