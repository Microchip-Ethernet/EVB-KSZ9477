 ...
 */
static void port_set_addr(struct ksz_sw *sw, uint port, const u8 *mac_addr)
{
	int i;
	SW_D reg;
#if (SW_SIZE == (2))
...
static inline void sw_setup_src_filter(struct ksz_sw *sw, const u8 *mac_addr)
{
	uint port;
