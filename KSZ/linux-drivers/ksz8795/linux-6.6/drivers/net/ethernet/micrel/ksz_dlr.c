...
static void prep_dlr_addr(struct ksz_dlr_info *dlr, const u8 *src)
{
...
static void dlr_change_addr(struct ksz_dlr_info *dlr, const u8 *addr)
{
...
static void prep_dlr(struct ksz_dlr_info *dlr, struct net_device *dev,
		     const u8 *src)
{
	dlr->dev = dev;
