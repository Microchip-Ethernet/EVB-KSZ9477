...
#ifndef DEVINIT
#if defined(CONFIG_SPI_FTDI) && defined(CONFIG_SPI_KSZ8895)
#define DEVINIT
#else
...
static int DEVINIT ksz8895_probe(struct spi_device *spi)
{
...
static int __devexit ksz8895_remove(struct spi_device *spi)
{
...
static struct spi_driver ksz8895_driver = {
	...
	.probe = ksz8895_probe,
	.remove = __devexit_p(ksz8895_remove),
};
