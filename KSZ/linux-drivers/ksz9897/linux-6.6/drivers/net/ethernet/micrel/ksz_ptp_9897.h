...
struct ptp_ops {
	...
	void (*init)(struct ptp_info *ptp, const u8 *mac_addr);
	void (*exit)(struct ptp_info *ptp);
	int (*stop)(struct ptp_info *ptp, int hw_access);
	void (*set_identity)(struct ptp_info *ptp, const u8 *addr);
	...
	int (*hwtstamp_ioctl)(struct ptp_info *ptp, struct ifreq *ifr,
			      u16 ports);
	int (*hwtstamp_ioctl_get)(struct ptp_info *ptp, struct ifreq *ifr);
	int (*hwtstamp_get)(struct ptp_info *ptp,
			    struct kernel_hwtstamp_config *config);
	int (*hwtstamp_set)(struct ptp_info *ptp,
